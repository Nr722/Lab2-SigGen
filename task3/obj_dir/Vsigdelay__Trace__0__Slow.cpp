...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+11,"count1", false,-1);
    tracep->declBit(c+12,"count2", false,-1);
    tracep->declBus(c+13,"delayed_signal", false,-1, 7,0);
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+11,(vlSelf->count1));
    bufp->fullBit(oldp+12,(vlSelf->count2));
    bufp->fullCData(oldp+13,(vlSelf->delayed_signal),8);
