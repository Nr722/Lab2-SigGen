...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgCData(oldp+0,(vlSelf->sigdelay__DOT__address1),8);
        bufp->chgCData(oldp+1,(vlSelf->sigdelay__DOT__address2),8);
        bufp->chgSData(oldp+2,(vlSelf->sigdelay__DOT__address1),10);
        bufp->chgSData(oldp+3,(vlSelf->sigdelay__DOT__address2),10);
    }
    ...
    bufp->chgBit(oldp+10,(vlSelf->count1));
    bufp->chgBit(oldp+11,(vlSelf->count2));
    bufp->chgCData(oldp+12,(vlSelf->delayed_signal),8);
}
